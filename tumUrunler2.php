...
<div id="TumSayfa">
    <div id="header">
     ...
     <div id="baslik2">
         ...
         <form action="arama2.php" method="POST">
            ...
            <div style="gap:5px;width:400px;display:flex;flex-direction: row;
            ...
            <div id="Sepetim">
             ...
             <ul id="hesabimSecenekler">
               <li id="Hesabim"><a href="#">
                  <div id="hesapresim"><img src="ProjeResimler/icons8-user-50.png" alt="" id="hesapresim2"></div><?=ucfirst($_SESSION["ad"])?><br><?=ucfirst($_SESSION["soyad"])?>
                  <ul>
    ...
    <div id="anaEkran">
        ...
        <?php
        include("baglan.php");
        $tumbilgisayarlar=$db->query("SELECT * FROM urunler INNER JOIN urunresimler ON urunresimler.urun_id=urunler.urun_id
        ...
        WHERE kategori.kategori_id IN(1,2,3);
         ");
         
        while($kayit=$tumbilgisayarlar->fetch())
        {
         
        ?>
        
        
         <div id="urun"><a href="goruntuleme2.php?urun_id=<?=$kayit["urun_id"]?>" id="gorunum"> 
           <div id="urunResim"><img src="ProjeResimler/<?=$kayit["katalog_resmi"]?>" alt=""></div> 
           <div id="urunBilgiler">
            <div id="urunModel"><?=$kayit["model_ad"]." ".$kayit["model_seri"]?> <br><div style="font-size:15px;"> Oyun Bilgisayarı</div></div>
            <ul>
           <?php
           ...
           <?php } ?>
            ...
            <div id="sepeteEkle">  <a href="tumUrunler2.php?urunid=<?=$kayit["urun_id"]?>" id="sepeteekle">Sepete Ekle</a></div>
           </div>
           </a>
         </div>
  <?php } ?>
