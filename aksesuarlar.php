...
<div id="TumSayfa">
    <div id="header">
     ...
     <div id="baslik2">
         ...
         <div id="baslik3">
            ...
            <input type="text" placeholder="Arama Yap" name="arama" required>
    ...
    <div id="anaEkran">
        ...
        <?php
        include("baglan.php");
        $aksesuarlar=$db->query("SELECT * FROM urunler INNER JOIN urunresimler ON urunresimler.urun_id=urunler.urun_id
        INNER JOIN fiyatlar ON fiyatlar.urun_id=urunler.urun_id
        INNER JOIN model ON model.model_id=urunler.model_id
        INNER JOIN kategori ON kategori.kategori_id=urunler.kategori_id
        WHERE urunler.kategori_id='4';
         ");
        while($kayit=$aksesuarlar->fetch())
        {
             
        ?>
        
         <div id="urun" style="height:600px"> <a href="goruntuleme.php?urun_id=<?=$kayit["urun_id"]?>" id="gorunum">
           <div id="urunResim2"><img src="ProjeResimler/<?=$kayit["katalog_resmi"]?>" alt="" style="width:150px;height:150px"></div> 
           <div id="urunBilgiler">
            <div id="urunModel"><?=$kayit["model_ad"]." ".$kayit["model_seri"]?> <br><div style="font-size:15px;">Oyuncu Mouse</div></div>
            <div id="fiyat">
            <ul>
           <?php
           ...
           <div id="sepeteEkle"><a href="aksesuarlar.php?urunid=<?=$kayit["urun_id"]?>" id="sepeteekle">Sepete Ekle</a></div>
           </a>
         </div>
  <?php } ?>
  ...
  <?php
      ...
      INNER JOIN urunresimler ON urunler.urun_id=urunresimler.urun_id
        ...
        ?>
         ...
         <div id="urun" style="height:600px"><a href="goruntuleme.php?urun_id=<?=$kayit["urun_id"]?>" id="gorunum"> 
           <div id="urunResim2"><img src="ProjeResimler/<?=$kayit["katalog_resmi"]?>" alt="" style="height:130px"></div> 
           <div id="urunBilgiler">
            <div id="urunModel"><?=$kayit["model_ad"]." ".$kayit["model_seri"]?> <br><div style="font-size:15px;">Oyuncu klavye </div></div>
            <ul>
           <?php
           $ozellikler=$db->query("SELECT * FROM ozellikdetay WHERE urun_id=".$kayit["urun_id"]);
           for($i=0;$i<5;$i++){
  ...
  <?php
      ...
      INNER JOIN urunresimler ON urunler.urun_id=urunresimler.urun_id
        ...
        ?>
         ...
         <div id="urun" style="height:600px;overflow:hidden"> <a href="goruntuleme.php?urun_id=<?=$kayit["urun_id"]?>" id="gorunum">
           <div id="urunResim2"><img src="ProjeResimler/<?=$kayit["katalog_resmi"]?>" alt="" style="width:260px;height:200px;"></div> 
           <div id="urunBilgiler">
            <div id="urunModel"><?=$kayit["model_ad"]." ".$kayit["model_seri"]?> <br><div style="font-size:15px;">Oyuncu kulaklık </div></div>
            <ul>
           <?php
           $ozellikler=$db->query("SELECT * FROM ozellikdetay WHERE urun_id=".$kayit["urun_id"]);
           for($i=0;$i<5;$i++){
