    ...
    <div id="header">
     ...
     <div id="baslik2">
         ...
         <form action="arama2.php" method="POST">
            ...
            <ul id="hesabimSecenekler"><a href="#">
...
<?php
            ...
            <div id="ekle10"><a href="goruntuleme2.php?urunid=<?=$urun["urun_id"]?>&urun_id=<?=$urun["urun_id"]?>"><input type="button" value="SEPETE EKLE"></a></div>
