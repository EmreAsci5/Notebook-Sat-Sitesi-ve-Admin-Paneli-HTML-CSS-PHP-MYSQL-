      ...
      INNER JOIN urunresimler ON urunler.urun_id=urunresimler.urun_id
        ...
        ?>
         ...
         <div id="urun" style="height:600px"><a href="goruntuleme2.php?urun_id=<?=$kayit["urun_id"]?>" id="gorunum"> 
           <div id="urunResim2"><img src="ProjeResimler/<?=$kayit["katalog_resmi"]?>" alt="" style="height:130px;width:150px;margin-top:20px"></div> 
           <div id="urunBilgiler">
           ...
           <?php } ?>
            ...
            <div id="sepeteEkle">  <a href="aksesuarlar2.php?urunid=<?=$kayit["urun_id"]?>" id="sepeteekle">Sepete Ekle</a></div>
           </div>
           </a>
         </div>
  <?php } ?>
  ...
  <?php
      ...
      INNER JOIN urunresimler ON urunler.urun_id=urunresimler.urun_id
        ...
        ?>
         ...
         <div id="urun" style="height:600px;overflow:hidden"><a href="goruntuleme2.php?urun_id=<?=$kayit["urun_id"]?>" id="gorunum"> 
