...
<div id="TumSayfa">
    ...
    <div id="anaEkran">
        ...
        <?php
        include("baglan.php");
        $Wrym=$db->query("SELECT * FROM urunler INNER JOIN urunresimler ON urunresimler.urun_id=urunler.urun_id
        INNER JOIN fiyatlar ON fiyatlar.urun_id=urunler.urun_id
        INNER JOIN model ON model.model_id=urunler.model_id
        INNER JOIN kategori ON kategori.kategori_id=urunler.kategori_id
        WHERE model.model_ad='Wrym';
         ");
        while($kayit=$Wrym->fetch())
        {
        ...
        ?>
         ...
         <div id="urun" style="height:600px"> <a href="goruntuleme.php?urun_id=<?=$kayit["urun_id"]?>" id="gorunum">
           ...
           <?php } ?>
            ...
            <div id="sepeteEkle">  <a href="Wrym.php?urunid=<?=$kayit["urun_id"]?>" id="sepeteekle">Sepete Ekle</a></div>
           </div>
           </a>
         </div>
  <?php } ?>
